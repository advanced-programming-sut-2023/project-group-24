...
public enum BuildingType {
    ...
    SMALL_STONE_GATEHOUSE_RIGHT("small stone gatehouse right", Category.CASTLE, null, 0, 1000,
            0, 8, 2, 0, 0, 0, 0,
            null, null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    SMALL_STONE_GATEHOUSE_LEFT("small stone gatehouse left", Category.CASTLE, null, 0, 1000,
            0, 8, 2, 0, 0, 0, 0,
            null, null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    ...
    LARGE_STONE_GATEHOUSE_RIGHT("large stone gatehouse right", Category.CASTLE, new Pair<>(Item.STONE, -20), 0,
            2000, 0, 10, 2, 0, 0, 0,
            0, null, null, 0, null, null,
            null, true, true, null, GateAndStairs.class),

    LARGE_STONE_GATEHOUSE_LEFT("large stone gatehouse left", Category.CASTLE, new Pair<>(Item.STONE, -20), 0,
            2000, 0, 10, 2, 0, 0, 0,
            0, null, null, 0, null, null,
            null, true, true, null, GateAndStairs.class),
    DRAWBRIDGE("drawbridge", Category.CASTLE, new Pair<>(Item.WOOD, -10), 0, 1000, 0,
            ...
            true, true, null, GateAndStairs.class),
    DRAWBRIDGE_RIGHT("drawbridge right", Category.CASTLE, new Pair<>(Item.WOOD, -10), 0, 1000, 0,
            0, 0, 0, 0, 0, 0, null,
            null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    DRAWBRIDGE_LEFT("drawbridge left", Category.CASTLE, new Pair<>(Item.WOOD, -10), 0, 1000, 0,
            0, 0, 0, 0, 0, 0, null,
            null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    ...
    QUARRY("quarry", Category.INDUSTRY, new Pair<>(Item.WOOD, -20), 0, 100,
            ...
            null, null, false, false,
            new Vector<>(List.of(Texture.SLAB)), ProducerBuilding.class),
    ...
    STAIR("stair", Category.CASTLE, new Pair<>(Item.STONE, -1), 0, 150,
            ...
            null, null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    STAIR_LEFT("stair left", Category.CASTLE, new Pair<>(Item.STONE, -1), 0, 150,
            0, 0, 1, 0, 0, 0, 0,
            null, null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    STAIR_RIGHT("stair right", Category.CASTLE, new Pair<>(Item.STONE, 0), 0, 150,
            0, 0, 1, 0, 0, 0, 0,
            null, null, 0, null, null, null,
            true, true, null, GateAndStairs.class),
    TOWN_HALL("town hall", Category.CASTLE, null, 0, 2000,
            ...
            null, null, 0, null, null, null,
            false, false, null, Building.class),
    TUNNELERS_GUILD("tunnelers guild", Category.ARMY_MAKER, null, 0, 500,
            0, 0, 0, 0, 0, 0, 0,
            null, null, 0, null, null, null,
            false, false, null, Building.class),
