...
class ProfileMenuControllerTest {
    ...
    private ProfileMenuController profileMenuController = new ProfileMenuController(database);
    ...
    @Test
    void showHighScore() {
        Assertions.assertEquals(profileMenuController.showHighScore(), "Your highscore is 0");
    }

    @Test
    void showRank() {
        Assertions.assertEquals(profileMenuController.showRank(), "Your rank is 1");
    }
